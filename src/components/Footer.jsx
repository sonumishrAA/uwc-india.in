            ...
            <div>
              <div className="flex justify-center text-black sm:justify-start">
                <img
                  ...
                  alt=""
                />
                <h1 className="h-8 bebas-neue-regular-f" viewBox="0 0 118 24">
              ...
              <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
                UWC aims to boost income opportunities for construction workers
                and contractors by making the labor market transparent and
                accessible, helping them find jobs and workers easily with
              ...
              <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                <li>
                  <a
                    href="https://www.facebook.com/profile.php?id=61569994220688&mibextid=JRoKGi"
                    rel="noreferrer"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://www.instagram.com/uwcindiaservices/profilecard/?igsh=azZ5NXNmM29tMTZ6"
                    rel="noreferrer"
                    target="_blank"
                    className="text-teal-700 transition hover:text-teal-700/75"
                  >
              ...
              <div className="text-center sm:text-left">
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  ...
                  <li>
                    <a
                      className="text-gray-700 transition hover:text-gray-700/75"
                      href="https://api.whatsapp.com/send/?phone=%2B919580599181&text=urlencodedtext&type=phone_number&app_absent=0"
                    >
                      {" "}
                      Support{" "}
                    </a>
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  ...
                  <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                    ...
                    <address className="-mt-0.5 flex-1 not-italic text-gray-700">
                      177 Mahaveer Market, Babaganj Pratapgarh, Uttar Pradesh
                    </address>
                  </li>
                </ul>
              </div>
          ...
          <div className="mt-12 border-t border-gray-100 pt-6">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              ...
              <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
                &copy; 2024 UWCINDIA | Developed by Sonu Mishra[NIT Rourkela]
              </p>
            </div>
          </div>
        </div>
